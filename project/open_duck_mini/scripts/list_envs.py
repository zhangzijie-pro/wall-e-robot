...
All the environments are registered in the `open_duck_mini` extension. They start
...
import open_duck_mini.tasks  # noqa: F401


def main():
    """Print all environments registered in `open_duck_mini` extension."""
